...
<body class="easyui-layout" style="visibility: hidden;">
	<div region="north" style="height: 31px; overflow: hidden;" split="false" border="false">
		<div class="datagrid-toolbar">
			<a id="save" icon="icon-save" href="#" class="easyui-linkbutton" plain="true">新单</a> <a id="edit" icon="icon-edit" href="${pageContext.request.contextPath }/page_qupai_noticebill.action"
				class="easyui-linkbutton" plain="true">工单操作</a>
		</div>
	</div>
	<div region="center" style="overflow: auto; padding: 5px;" border="false">
		<form id="noticebillForm" action="noticebillAction_saveNoticebill.action" method="post">
			<table class="table-edit" width="100%" align="center">
				...
				<tr>
					   ...
					   <script type="text/javascript">
					       $(function(){
					    	   $("input[name=telephone]").blur(function(){
					    		   // 获取输入的电话号
					    		   var tel = this.value;
					    		   $.post("customerAction_findByTel.action",{c_Tel:tel},function(data){
					    			   if(data!=null){
					    				   var id = data.id;
					    				   var name = data.name;
                                           ...
                                           $("input[name=pickaddress]").val(addr);
					    			   }else{
					...
					<td>客户编号:</td>
					<td><input type="text" class="easyui-validatebox" name="customerId" required="true" /></td>
				</tr>
				<tr>
					<td>客户姓名:</td>
					<td><input type="text" class="easyui-validatebox" name="customerName" required="true" /></td>
					<td>联系人:</td>
					<td><input type="text" class="easyui-validatebox" name="delegater" required="true" /></td>
				</tr>
				<tr class="title">
